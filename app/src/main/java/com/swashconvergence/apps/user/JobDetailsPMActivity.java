...
public class JobDetailsPMActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.feed_pm_row_item_details);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.apply_mode:
                Intent readMorIntent=new Intent(JobDetailsPMActivity.this,LoginActivity.class);
