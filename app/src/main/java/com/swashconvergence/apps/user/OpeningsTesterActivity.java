...
public class OpeningsTesterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.feed_tester_row_item);
        initView();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.textView_read_more:
                Intent readMorIntent=new Intent(OpeningsTesterActivity.this,JobDetailsTesterActivity.class);
                startActivity(readMorIntent);
                //finish();
            break;
            case R.id.textView_read_more1:
                Intent readMorIntent2=new Intent(OpeningsTesterActivity.this,JobDetailsTesterActivity.class);
                startActivity(readMorIntent2);
                //finish();
                break;
            case R.id.textView_read_more2:
                Intent readMorIntent3=new Intent(OpeningsTesterActivity.this,JobDetailsTesterActivity.class);
