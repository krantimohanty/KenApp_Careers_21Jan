...
public class JobDetailsTesterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.feed_tester_row_item_details);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.apply_mode:
                Intent readMorIntent=new Intent(JobDetailsTesterActivity.this,LoginActivity.class);
